...
export default function GroupsPage() {
  ...
  // 2. Guest Upgrade Block
  if (isGuest) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6 bg-slate-950 text-white min-h-screen text-center">
        <div className="glass-card p-10 max-w-lg w-full flex flex-col items-center gap-6 border-slate-800">
          ...
          <p className="text-slate-400 text-base leading-relaxed">
            Gaming circles allow you to manage play groups, invite your table buddies, and track leaderboards. 
            <span className="block mt-2 font-semibold text-brand-400">This feature requires a registered account.</span>
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 mt-2 w-full">
            <Link 
              href="/auth/register"
              className="flex-1 py-3 px-4 bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-500 hover:to-brand-600 text-white font-medium rounded-xl border border-brand-600/30 hover:border-brand-500/50 shadow-lg shadow-brand-950/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
              Register Now
            ...
            <Link 
              href="/dashboard"
              className="flex-1 py-3 px-4 bg-slate-900/50 hover:bg-slate-800 text-slate-300 border border-slate-800 hover:border-slate-700 font-medium rounded-xl transition-all flex items-center justify-center cursor-pointer"
            >
              Back to Dashboard
            </Link>
          </div>
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-8 flex flex-col gap-6">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">
            Organize match sessions, compare stats, and invite playing partners.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="glass-card p-12 text-center flex flex-col items-center gap-4 border-slate-900 mt-4">
            ...
            <h3 className="font-display font-bold text-lg text-white">No Circles Yet</h3>
